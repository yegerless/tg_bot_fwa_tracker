...
def get_kalories_chart(logged_kalories: dict[str, int], burned_kalories: dict[str, int], 
    ...
    '''
        Функция get_kalories_chart - принимает данные о полученных и 
            ...
            объекта (который затем можно отправить пользователю).
        Аргументы:
            logged_kalories (dict(str: int)) - данные о полученных калориях 
                по дням в виде словаря в формате {день: кол-во калорий}.
            burned_kalories (dict(str: int)) - данные о сожженных калориях
                по дням в виде словаря в формате {день: кол-во калорий}.
